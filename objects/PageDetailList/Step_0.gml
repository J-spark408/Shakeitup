...
//	var getStage = ds_list_find_value(StageData.stage_list, stageIndex);
//	if (getStage.stage_unlocked == true) {
//		if (getStage.stage_level == 0 && getStage.stage_recipe_created) {
...
//			getStage.stage_recipe_created = true;
