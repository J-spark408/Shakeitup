...
if (!createdPhysics) {
	...
	physics_fixture_add_point(leftside,-0.23,-3.847);
	physics_fixture_add_point(leftside,20.466,-0.847);
	physics_fixture_add_point(leftside,54.503,300.03);
	physics_fixture_add_point(leftside,28.09,300.76);
	...
	physics_fixture_add_point(rightside,152.27,0.189);
	physics_fixture_add_point(rightside,174.88,-2.279);
	physics_fixture_add_point(rightside,153.24,300.712);
	physics_fixture_add_point(rightside,124.67,303.27);
	...
	physics_fixture_add_point(bottom,25.58,279.46);
	physics_fixture_add_point(bottom,154.532,279.347);
	physics_fixture_add_point(bottom,147.75,305.726);
	physics_fixture_add_point(bottom,31.839,305.726);
