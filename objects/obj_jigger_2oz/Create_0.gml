event_inherited();
top_right_origin = 124;

isSelected = false;

leftside = physics_fixture_create();
physics_fixture_set_polygon_shape(leftside);
physics_fixture_add_point(leftside,-3.6-top_right_origin,-2.17);
physics_fixture_add_point(leftside,15.90-top_right_origin,2.313);
physics_fixture_add_point(leftside,46.10-top_right_origin,110.26);
physics_fixture_add_point(leftside,26.29-top_right_origin,110.17);
...
physics_fixture_add_point(rightSide,107.39-top_right_origin,-0.17);
physics_fixture_add_point(rightSide,126.90-top_right_origin,-4.68);
physics_fixture_add_point(rightSide,97.10-top_right_origin,110.29);
physics_fixture_add_point(rightSide,77.29-top_right_origin,110.17);
...
physics_fixture_add_point(middle,15.90-top_right_origin,92.41);
physics_fixture_add_point(middle,108.0-top_right_origin,92.32);
physics_fixture_add_point(middle,101.51-top_right_origin,121.97);
physics_fixture_add_point(middle,22.56-top_right_origin,121.38);
...
//image_speed = 0; // Set the animation speed to 0 to freeze the animation
//image_xscale_original = image_xscale; // Store the original scale
//image_yscale_original = image_yscale;
//is_flipped = false; // Variable to track flipping state

//image_xscale = image_xscale_original;
//image_yscale = image_yscale_original;
//image_angle = 0;
//image_xoffset = sprite_width / 2;
//image_yoffset = sprite_height / 2;
